...
const indice = salarios.findIndex((salario) => salario > 7500);

console.log(indice);

const salariosMaioresQue8000 = salarios.filter((salario) => salario > 8000);

console.log(salariosMaioresQue8000);
